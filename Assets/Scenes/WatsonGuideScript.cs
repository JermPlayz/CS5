...
/*public class WatsonGuideScript : MonoBehaviour
{
    ...
    private string text1 = "Hello, rookie Coder! Welcome to CS5: Byte and Battle! I’m Watson, your computing companion, here to keep you from getting compiled into oblivion. Ready to debug this mainframe?";
    ...
    private string text6 = "That’s the spirit! Take out the last Glitch, and Level 1 is yours. I’ll pop back if you need me. Compile those Glitches!";
    private string text7 = "Keep going there is more enemies to defeat!";
    private string text8 = "Come to the other side of the map and the next level will begin! ";
    private void Start()
    {
